...
public class CustomerController {
    ...
    if(index<customers.size())
    {
        ...
        return new ApiResponse("Can't Update a balance","400");
    }

    @PutMapping ("/withdrawmoney/{index}/{money}")
    public ApiResponse withdrawMoney(@PathVariable int index,@PathVariable int money) {
        if(index<customers.size()) {
            ...
            return new ApiResponse("Can't Update a balance, the balance is insufficient", "400");
